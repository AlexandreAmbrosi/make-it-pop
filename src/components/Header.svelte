...
<div class="relative mx-auto flex max-w-7xl flex-row items-center justify-between px-8 pt-2">
  ...
  <div class="hidden flex-row items-center gap-x-8 sm:flex">
    ...
    <a class={['hover:text-launchfast text-sm text-gray-800 hover:underline', $page.url.pathname.includes('/inspird') && 'font-semibold'].filter(Boolean).join(' ')} href="/inspird">
      Inspird
    </a>
  ...
  >
    ...
    <div class="flex flex-col gap-y-4 p-5">
      ...
      <a class={[$page.url.pathname.includes('/inspird') && 'font-semibold'].filter(Boolean).join(' ')} href="/inspird">Inspird</a>
