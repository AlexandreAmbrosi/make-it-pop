...
<img data-pagefind-meta="image[src]" width="1600" height="900" alt="TODO: A Step-by-Step Guide" decoding="async" loading="eager" class="mt-4 border rounded bg-cover bg-center bg-no-repeat transform will-change-auto" src="https://ik.imagekit.io/vjeqenuhn/launchfast-website/general" />
