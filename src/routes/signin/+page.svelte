      ...
      <form on:submit={handleSubmit} class="flex w-full max-w-[446px] flex-col gap-6">
        ...
        <div in:fly={{ y: 20, duration: 400, delay: 100 }} class="flex flex-col items-center gap-6 pb-0">
          ...
          <div class="space-y-2 text-center">
            <h1 class="text-[18px] leading-[16px] font-medium text-neutral-950">Welcome back, fellow designer!</h1>
            <p class="text-[16px] leading-[24px] text-[#717182]">New content is waiting for you :)</p>
          </div>
        </div>
        ...
        <div in:fly={{ y: 20, duration: 400, delay: 300 }} class="flex flex-col items-center gap-6 px-4">
          ...
          >
            {#if loading}
              ...
              <span class="text-[14px] leading-[20px] font-medium">Loading...</span>
            {:else}
              <span class="text-[14px] leading-[20px] font-medium">Jump in !</span>
              <svg class="h-4 w-4" fill="none" viewBox="0 0 16 16">
                <!-- Simple arrow right path replacement for svgPaths.p28e93fc0/pc444e40 -->
          ...
          <div class="flex items-center gap-1.5">
            <span class="text-[14px] leading-[20px] text-[#717182]">No account ?</span>
            <a href="/signup" class="cursor-pointer text-[14px] leading-[24px] font-medium text-neutral-950 transition-all hover:underline disabled:opacity-50">
              Sign up for free
            </a>
          </div>
        </div>
